...
protractor.expect = {
  challengeSolved: function (context) {
    describe('(shared)', () => {
      ...
      if (context.wafshouldblock === undefined) {
        context.wafshouldblock = "Unknown"
      }
      it("WAF should block: " + context.wafshouldblock + " ; Category: " + context.category + "; Challenge '" + context.challenge + "'", () => {
