...
describe('/redirect', () => {
  ...
  describe('challenge "redirect"', () => {
    ...
    protractor.expect.challengeSolved({ challenge: 'Whitelist Bypass', category: 'Remote File Inclusion', wafshouldblock: "Yes" })
  })
  ...
  describe('challenge "redirectCryptoCurrency"', () => {
    ...
    protractor.expect.challengeSolved({ challenge: 'Outdated Whitelist', category: 'Remote File Inclusion', wafshouldblock: "Yes" })
  })
})
