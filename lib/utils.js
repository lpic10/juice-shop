...
function isRemoteTest() {
  return process.argv[2] === 'protractor.remote.conf.js'
}

exports.isRemoteTest = isRemoteTest()
...
exports.disableOnContainerEnv = () => {
  return ((isDocker() || isHeroku) && !config.get('challenges.safetyOverride') || isRemoteTest())
}
